...
label1=Label(root,text="TO-DO LIST",font="ariel,40,bold",fg="blue",bg="green")
label1.place(x=80,y=20)

frame=Frame(root,width=400,height=40,bg="grey")
...
button=Button(frame,text="Add task",font="ariel,5,bold",bg="blue",fg="white",width=7,command=addtask)
...
btn2=Button(root,text="DONE",bd=0,bg="red",fg="white",command=done)
