...
labelframe=LabelFrame(root, text="Random Password Generator",font="arial,40,bold",bg="white")
labelframe.pack(pady=20)

entry=Entry(labelframe,font="ariel,20",bg="white")
entry.pack(padx=20,pady=20)

password_entry=Entry(root,text="",font="ariel,24,italic",bg="white")
